        ...
        <div className="hidden md:flex space-x-6 items-center">
          ...
          <div className="relative group">
            ...
            <div className="absolute left-0 hidden group-hover:flex flex-col bg-orange-400 text-white mt-2 py-2 rounded shadow-lg w-40 z-50">
              <Link href="/info/event" className="block px-4 py-2 hover:font-bold">
                Event
              </Link>
              <Link href="/info/agenda" className="block px-4 py-2 hover:font-bold">
                Agenda
              </Link>
              <Link href="/info/kegiatan" className="block px-4 py-2 hover:font-bold">
                Kegiatan
              </Link>
              <Link href="/info/artikel" className="block px-4 py-2 hover:font-bold">
                Artikel
              </Link>
            </div>
          </div>
          ...
          <div className="relative group">
            <Link
              href="/dokumen"
              className="transition font-medium hover:font-bold flex items-center gap-1 group"
            >
              <span>Dokumen</span>
              <ChevronDown className="hidden group-hover:inline-block w-4 h-4 transition-transform duration-200 group-hover:rotate-180" />
            </Link>
            ...
            <div className="absolute left-0 hidden group-hover:flex flex-col bg-orange-400 text-white mt-2 py-2 rounded shadow-lg w-40 z-50">
              <Link href="/dokumen/juknis" className="block px-4 py-2 hover:font-bold">
                Juknis LK I
              </Link>
              <Link href="/dokumen/modul" className="block px-4 py-2 hover:font-bold">
                Modul LK I
              </Link>
              <Link href="/dokumen/berkas" className="block px-4 py-2 hover:font-bold">
                Berkas
              </Link>
              <Link href="/dokumen/konstitusi" className="block px-4 py-2 hover:font-bold">
                Konstitusi
              </Link>
              <Link href="/dokumen/artikel" className="block px-4 py-2 hover:font-bold">
                Loka-karya
              </Link>
            </div>
          </div>
        ...
        >
          ...
          <details className="w-full">
            ...
            <div className="pl-4 mt-1 space-y-1">
              ...
              <Link href="/info/berita" className="block px-4 py-2 hover:font-bold">
                Berita
              </Link>
              <Link href="/info/artikel" className="block px-4 py-2 hover:font-bold">
                Artikel
          ...
          {/* Dropdown Dokumen (Mobile) */}
          <details className="w-full">
            <summary className="cursor-pointer hover:font-bold">Dokumen</summary>
            <div className="pl-4 mt-1 space-y-1">
              <Link href="/dokumen/juknis" className="block px-4 py-2 hover:font-bold">
                Juknis LK I
              </Link>
          ...
          <button onClick={() => setDarkMode(!darkMode)} className="w-full text-left">
